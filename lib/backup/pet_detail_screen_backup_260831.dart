...
class PetDetailScreenBackup2 extends StatefulWidget {
  final Pet pet;

  const PetDetailScreenBackup2({super.key, required this.pet});
  ...
  */
  @override
  State<PetDetailScreenBackup2> createState() => _PetDetailScreenState();
}

class _PetDetailScreenState extends State<PetDetailScreenBackup2> {
  Pet? currentPet;
